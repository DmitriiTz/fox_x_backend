    ...
    $('#saveProfile').click(function() {
        ...
        if ($('#password').val() !== $('#password-check').val()) {
            ...
            $.ajax({
                ...
                method: 'POST',
                data: { email: $('input[name="email"]').val(), password: $('input[name="password"]').val(), vk: $('input[name="vk"]').val(), telegram: $('input[name="telegram"]').val(), facebook: $('input[name="facebook"]').val(), '_token': $('meta[name="csrf-token"]').attr('content') },
                success: function(result) {
