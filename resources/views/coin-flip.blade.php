...
@section('content')
    ...
    <main class="main">
            ...
            <div class="create-game">
                ...
                <div class="create-game__body">
                    ...
                    @if(auth()->user() && auth()->user()->id != 4)
                        <a href="javascript:void(0);" data-izimodal-open="#createGame" onclick="$(this).addClass('hide');"
                           data-izimodal-transitionin="fadeInDown" class="create-game__button">
                            <span>+</span><br>
                            Создать<br> игру
                        </a>
                    @else
                        <a href="javascript:void(0);" class="create-game__button" data-izimodal-open="#auth"
                        ...
                        <div class="coin-history__right">
                            @if(auth()->user() && auth()->user()->id != 4)
                                ...
                                <div class="coin-history-box">
                                    ...
                                    <div class="coin-history-box__col coin-history-box__col--last">
                                        <p class="coin-history-box__value coin-history-box__value--orange">{{ $bankUser }}
                                            <span>COINS</span></p>
        ...
        <!-- @include('blocks.notification', ['isMobile' => 1]) -->
            ...
            <ul class="hide">
                ...
                <li class="hide">
                    <a data-izimodal-open="#waitPlayer" data-izimodal-transitionin="fadeInDown">Окно 2, ожидание второго игрока или
                        зрителя</a>
                </li>
                <li>
                    <a data-izimodal-open="#waitPlayer2" data-izimodal-transitionin="fadeInDown">Окно 3 , когда присоединился второй
                        игрок</a>
                </li>
                <li>
            ...
            <form class="bet__form">
                <div class="bet__form-wrap">
                    ...
                    <div id="coins" class="bet__form-box">
                        <input type="number" class="bet__form-input" value="12345" onchange="MainFunction.calculate(this);"
                               onkeyup="MainFunction.calculate(this);">
    ...
    <div class="modal modal--bet " id="betModalCoin">
        ...
        <div class="modal__body">
            ...
            <form class="bet__form">
                ...
                <div class="bet__form-wrap">
                    ...
                    <div id="coins2" class="bet__form-box">
                        <input type="number" name="balance" class="bet__form-input" name="cash"
                               onkeyup="MainFunction.validatePrice(this); MainFunction.calculate(this, event, 'coinflip');"
            ...
            <div class="modal__buttons">
                ...
                <a href="#" class="button button--border" data-izimodal-open="#inputModal"
    ...
    <div class="modal modal--bet" id="createGame">
        ...
        <div class="coin-create">
            <div class="coin-create__orange">
                <a onclick="MainFunction.selectColor('orange');" data-izimodal-open="#betModalCoin" data-izimodal-transitionin="fadeInDown"
                   class="coin-create__icon">
                    <i class="ic-coin-orange"></i>
                </a>
            ...
            <div class="coin-create__center coin-create__center--one">
                ...
                <div class="wait-palyer__timer hide">
                    <i class="ic-timer"></i>
            ...
            <div class="coin-create__blue">
                <a onclick="MainFunction.selectColor('blue');" data-izimodal-open="#betModalCoin" data-izimodal-transitionin="fadeInDown"
                   class="coin-create__icon">
    ...
    <script>
        $("#createGame, #waitPlayer, #waitPlayer2, #waitPlayer3, #waitPlayer4, #waitPlayer5, #waitPlayer6, #waitPlayer7, #waitPlayer8").iziModal({
            ...
            onClosing: function () {
                $('.create-game__button').removeClass('hide');
            }
        });
